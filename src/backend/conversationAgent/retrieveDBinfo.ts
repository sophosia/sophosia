...
export async function retrieveReferenceid(supabase: SupabaseClient, reference_label: string): Promise<string> {
 ...
 */
export async function retrieveCategoryid(supabase: SupabaseClient, category_uid: string): Promise<string> {
