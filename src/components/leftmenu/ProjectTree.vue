 ...
 * @param {string} _projectid - The ID of the project to export.
 */
...
/**
 * Exports the citation of a project in the specified format.
 * @param {string} format - The format to export the citation in.
