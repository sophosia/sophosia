...
> [!NOTE]  
> ## For normal users, download Sophosia from the [newest release](https://github.com/sophosia/sophosia/releases/latest).
> ## If you want to contribute to Sophosia, follow the [instructions below](#contribute-to-sophosia)
